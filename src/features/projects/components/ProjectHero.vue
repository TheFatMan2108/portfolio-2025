...
.project-hero {
  ...
  &-buttons {
    font-family: var(--portfolio-font-buttons, var(--portfolio-font-family, "Urbanist", Arial, sans-serif));
    grid-row: 3;
    grid-column: 1 / 13;
    display: flex;
    align-items: center;
  ...
  &-title {
    font-family: var(--portfolio-font-project-title, var(--portfolio-font-family, "Urbanist", Arial, sans-serif));
  ...
  &-description {
    font-family: var(--portfolio-font-project-description, var(--portfolio-font-family, "Urbanist", Arial, sans-serif));
    color: var(--project-description-color, var(--color-text-400));
