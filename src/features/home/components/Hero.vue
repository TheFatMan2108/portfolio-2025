    ...
    <div class="hero-content grid">
      <div class="hero-content-inner" id="hero-content-inner">
        <div class="hero-content-copys">
          <h1 class="hero-title">
            {{ portfolioData.profile.firstName }}<br />{{ portfolioData.profile.lastName }}
          </h1>
...
.hero {
  ...
  &-title {
    font-family: var(--portfolio-font-hero-name, var(--portfolio-font-family, "Urbanist", Arial, sans-serif));
    font-weight: 900;
  ...
  &-banner {
    --portfolio-banner-font-family: var(
      --portfolio-font-job-title,
      var(--portfolio-display-font-family, "ProFontWindows", monospace)
    );
    position: absolute;
    bottom: 0;
    right: -16px;
