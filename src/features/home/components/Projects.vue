...
import { getProjectPreviews, portfolioData } from "../../../content/portfolio";

import type { ProjectPreview } from "../../../content/types";

const loadedPreviews = computed<ProjectPreview[]>(() => getProjectPreviews(locale.value ?? "en"));
...
watch([locale, portfolioData], notifyLoaded);

onMounted(notifyLoaded);
</script>
...
.projects {
  ...
  &-title {
    ...
    &-copy {
      font-family: var(--portfolio-font-projects-title, var(--portfolio-font-family, "Urbanist", Arial, sans-serif));
      font-weight: 900;
