    ...
    <div ref="wrapperRef" class="box-description">
      <div class="box-description-content">
        <div class="box-description-details">
          <p class="box-description-details-name">{{ portfolioData.profile.firstName }}</p>
...
.box-description {
  ...
  &-details {
    ...
    &-name {
      font-family: var(--portfolio-font-hero-name, var(--portfolio-display-font-family, monospace));
    ...
    &-location {
      ...
      &-copy {
        font-family: var(--portfolio-font-location, var(--portfolio-display-font-family, monospace));
  ...
  &-copy {
    font-family: var(--portfolio-font-about-tagline, var(--portfolio-display-font-family, monospace));
    will-change: opacity;
    font-size: var(--font-size-md);
    padding: var(--space-sm) var(--space-md);
